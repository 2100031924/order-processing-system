...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Object> paymentResultConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.orderservice.event,com.example.orderservice.*,java.util,java.lang");
        props.put(JsonDeserializer.TYPE_MAPPINGS, "PaymentCompletedEvent:com.example.orderservice.event.PaymentCompletedEvent,PaymentFailedEvent:com.example.orderservice.event.PaymentFailedEvent");
    ...
    @Bean
    public DefaultErrorHandler orderStatusErrorHandler(KafkaOperations<String, Object> kafkaOperations) {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactory(
            ConsumerFactory<String, Object> paymentResultConsumerFactory,
